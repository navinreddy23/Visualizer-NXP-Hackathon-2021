...
/* [0x1010,0x00] Store Parameters - Highest Subindex (Unsigned8) */ \
SDOREPLY(0x1010, 0x00, 1, 0x00000004L), \
/* [0x1011,0x00] Restore Parameters - Highest Subindex (Unsigned8) */ \
...
/* [0x1400,0x00] Receive PDO Communication 1 - Highest Subindex (Unsigned8) */ \
SDOREPLY(0x1400, 0x00, 1, 0x00000005L), \
/* [0x1400,0x01] Receive PDO Communication 1 - COB ID used by PDO (Unsigned32) */ \
SDOREPLY(0x1400, 0x01, 4, 0x00000000L), \
/* [0x1400,0x02] Receive PDO Communication 1 - Transmission Type (Unsigned8) */ \
SDOREPLY(0x1400, 0x02, 1, 0x000000FFL), \
/* [0x1400,0x03] Receive PDO Communication 1 - Inhibit Time (Unsigned16) */ \
SDOREPLY(0x1400, 0x03, 2, 0x00000000L), \
/* [0x1400,0x05] Receive PDO Communication 1 - Event Timer (Unsigned16) */ \
SDOREPLY(0x1400, 0x05, 2, 0x00000000L), \
\
/* RPDO mapping parameters */ \
/* [0x1600,0x00] Receive PDO Mapping 1 - Highest Subindex (Unsigned8) */ \
SDOREPLY(0x1600, 0x00, 1, 0x00000002L), \
/* [0x1600,0x01] Receive PDO Mapping 1 - Mapping 1 (Unsigned32) */ \
SDOREPLY(0x1600, 0x01, 4, 0x61000108L), \
/* [0x1600,0x02] Receive PDO Mapping 1 - Mapping 2 (Unsigned32) */ \
SDOREPLY(0x1600, 0x02, 4, 0x61000208L), \
\
/* [0x6100,0x00] VoiceCommands - Highest Subindex (Unsigned8) */ \
SDOREPLY(0x6100, 0x00, 1, 0x00000002L), \
...
ODENTRY(0x6100, 0x01, 1+ODRD+ODWR+WMAP, P610001_VC_Command), \
ODENTRY(0x6100, 0x02, 1+ODRD+ODWR+WMAP, P610002_VC_Accuracy), \
ODENTRY(0x1002, 0x00, 4+ODRD, P100200_Manufacturer_Status_Register), \
ODENTRY(0x1003, 0x00, 1+ODRD+ODWR, P100300_Number_of_Errors), \
ODENTRY(0x1003, 0x01, 4+ODRD, P100301_Pre_Defined_Error_Field_1), \
ODENTRY(0x1003, 0x02, 4+ODRD, P100302_Pre_Defined_Error_Field_2), \
ODENTRY(0x1003, 0x03, 4+ODRD, P100303_Pre_Defined_Error_Field_3), \
ODENTRY(0x1003, 0x04, 4+ODRD, P100304_Pre_Defined_Error_Field_4), \
...
ODENTRY(0x1011, 0x01, 4+ODRD+ODWR, P101101_Save_All_Parameters), \
ODENTRY(0x1011, 0x02, 4+ODRD+ODWR, P101102_Restore_Communication_Parameters), \
ODENTRY(0x1011, 0x03, 4+ODRD+ODWR, P101103_Restore_Application_Parameters), \
ODENTRY(0x1011, 0x04, 4+ODRD+ODWR, P101104_Restore_Manufacturer_Parameters), \
ODENTRY(0x1016, 0x01, 4+ODRD+ODWR, P101601_Consumer_Heartbeat_Time_1), \
ODENTRY(0x1016, 0x02, 4+ODRD+ODWR, P101602_Consumer_Heartbeat_Time_2), \
ODENTRY(0x1016, 0x03, 4+ODRD+ODWR, P101603_Consumer_Heartbeat_Time_3), \
...
ODENTRY(0x1400, 0x01, 4+ODRD+ODWR, P140001_COB_ID_used_by_PDO), \
ODENTRY(0x1400, 0x02, 1+ODRD+ODWR, P140002_Transmission_Type), \
ODENTRY(0x1400, 0x03, 2+ODRD+ODWR, P140003_Inhibit_Time), \
ODENTRY(0x1400, 0x05, 2+ODRD+ODWR, P140005_Event_Timer), \
...
#define OD_ID_LIST \
  ...
  0x140000, /* [0x1400,0x00] Receive PDO Communication 1 - Highest Subindex (Unsigned8) */ \
  0x140001, /* [0x1400,0x01] Receive PDO Communication 1 - COB ID used by PDO (Unsigned32) */ \
  0x140002, /* [0x1400,0x02] Receive PDO Communication 1 - Transmission Type (Unsigned8) */ \
  0x140003, /* [0x1400,0x03] Receive PDO Communication 1 - Inhibit Time (Unsigned16) */ \
  0x140005, /* [0x1400,0x05] Receive PDO Communication 1 - Event Timer (Unsigned16) */ \
  0x160000, /* [0x1600,0x00] Receive PDO Mapping 1 - Highest Subindex (Unsigned8) */ \
  0x160001, /* [0x1600,0x01] Receive PDO Mapping 1 - Mapping 1 (Unsigned32) */ \
  0x160002, /* [0x1600,0x02] Receive PDO Mapping 1 - Mapping 2 (Unsigned32) */ \
  0x5FFF00, /* [0x5FFF,0x00] EmSA (VisibleString) */ \
  0x610000, /* [0x6100,0x00] VoiceCommands - Highest Subindex (Unsigned8) */ \
  0x610001, /* [0x6100,0x01] VoiceCommands - VC_Command (Unsigned8) */ \
  0x610002, /* [0x6100,0x02] VoiceCommands - VC_Accuracy (Unsigned8) */ \
...
#define OD_ID_TYPE \
  ...
  TYPE_UNSIGNED8      , /* [0x1400,0x00] Receive PDO Communication 1 - Highest Subindex (Unsigned8) */ \
  TYPE_UNSIGNED32     , /* [0x1400,0x01] Receive PDO Communication 1 - COB ID used by PDO (Unsigned32) */ \
  TYPE_UNSIGNED8      , /* [0x1400,0x02] Receive PDO Communication 1 - Transmission Type (Unsigned8) */ \
  TYPE_UNSIGNED16     , /* [0x1400,0x03] Receive PDO Communication 1 - Inhibit Time (Unsigned16) */ \
  TYPE_UNSIGNED16     , /* [0x1400,0x05] Receive PDO Communication 1 - Event Timer (Unsigned16) */ \
  TYPE_UNSIGNED8      , /* [0x1600,0x00] Receive PDO Mapping 1 - Highest Subindex (Unsigned8) */ \
  TYPE_UNSIGNED32     , /* [0x1600,0x01] Receive PDO Mapping 1 - Mapping 1 (Unsigned32) */ \
  TYPE_UNSIGNED32     , /* [0x1600,0x02] Receive PDO Mapping 1 - Mapping 2 (Unsigned32) */ \
  TYPE_VISIBLE_STRING , /* [0x5FFF,0x00] EmSA (VisibleString) */ \
  TYPE_UNSIGNED8      , /* [0x6100,0x00] VoiceCommands - Highest Subindex (Unsigned8) */ \
  TYPE_UNSIGNED8      , /* [0x6100,0x01] VoiceCommands - VC_Command (Unsigned8) */ \
  TYPE_UNSIGNED8      , /* [0x6100,0x02] VoiceCommands - VC_Accuracy (Unsigned8) */ \
...
#define OD_ID_TABLELOCATION \
  ...
  ODLOC_ODENTRY , /* [0x1003,0x00] Pre-Defined Error Field - Number of Errors (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x1003,0x01] Pre-Defined Error Field - Pre-Defined Error Field 1 (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1003,0x02] Pre-Defined Error Field - Pre-Defined Error Field 2 (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1003,0x03] Pre-Defined Error Field - Pre-Defined Error Field 3 (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1003,0x04] Pre-Defined Error Field - Pre-Defined Error Field 4 (Unsigned32) */ \
  ...
  ODLOC_SDOREPLY, /* [0x1010,0x00] Store Parameters - Highest Subindex (Unsigned8) */ \
  ...
  ODLOC_SDOREPLY, /* [0x1011,0x00] Restore Parameters - Highest Subindex (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x1011,0x01] Restore Parameters - Save All Parameters (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1011,0x02] Restore Parameters - Restore Communication Parameters (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1011,0x03] Restore Parameters - Restore Application Parameters (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1011,0x04] Restore Parameters - Restore Manufacturer Parameters (Unsigned32) */ \
  ...
  ODLOC_ODENTRY , /* [0x1016,0x01] Consumer Heartbeat Time - Consumer Heartbeat Time 1 (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1016,0x02] Consumer Heartbeat Time - Consumer Heartbeat Time 2 (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1016,0x03] Consumer Heartbeat Time - Consumer Heartbeat Time 3 (Unsigned32) */ \
  ...
  ODLOC_SDOREPLY, /* [0x1400,0x00] Receive PDO Communication 1 - Highest Subindex (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x1400,0x01] Receive PDO Communication 1 - COB ID used by PDO (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1400,0x02] Receive PDO Communication 1 - Transmission Type (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x1400,0x03] Receive PDO Communication 1 - Inhibit Time (Unsigned16) */ \
  ODLOC_ODENTRY , /* [0x1400,0x05] Receive PDO Communication 1 - Event Timer (Unsigned16) */ \
  ODLOC_SDOREPLY, /* [0x1600,0x00] Receive PDO Mapping 1 - Highest Subindex (Unsigned8) */ \
  ODLOC_SDOREPLY, /* [0x1600,0x01] Receive PDO Mapping 1 - Mapping 1 (Unsigned32) */ \
  ODLOC_SDOREPLY, /* [0x1600,0x02] Receive PDO Mapping 1 - Mapping 2 (Unsigned32) */ \
  ODLOC_ODGENTRY, /* [0x5FFF,0x00] EmSA (VisibleString) */ \
  ODLOC_SDOREPLY, /* [0x6100,0x00] VoiceCommands - Highest Subindex (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x6100,0x01] VoiceCommands - VC_Command (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x6100,0x02] VoiceCommands - VC_Accuracy (Unsigned8) */ \
